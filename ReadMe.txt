========================================================================
   APPLICATION CONSOLE : Vue d'ensemble du projet ShootEmUp
========================================================================

AppWizard a créé cette application ShootEmUp pour vous.

Ce fichier contient un résumé des éléments contenus dans chaque fichier qui
constitue votre application ShootEmUp.
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) nommé ShootEmUp.pch et un fichier de types précompilés 
    nommé StdAfx.obj.
